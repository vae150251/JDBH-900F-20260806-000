...
#define GPIO_SD3077SCL		GPIOE
#define GPIO_Pin_SD3077SCL	GPIO_Pin_4
#define GPIO_SD3077SDA		GPIOE
#define GPIO_Pin_SD3077SDA	GPIO_Pin_3

#define SCLSD3077_H         GPIO_SD3077SCL->BSRR = GPIO_Pin_SD3077SCL
#define SCLSD3077_L         GPIO_SD3077SCL->BRR = GPIO_Pin_SD3077SCL

#define SDASD3077_H         GPIO_SD3077SDA->BSRR = GPIO_Pin_SD3077SDA
#define SDASD3077_L         GPIO_SD3077SDA->BRR = GPIO_Pin_SD3077SDA

#define SDASD3077_read      GPIO_SD3077SDA->IDR  & GPIO_Pin_SD3077SDA
...
void Drive_Read_clock(u8 *ptr);
void Drive_Wirte_clock(u8 *ptr);
...
/*********I2C端口初始化函数*********/
void I2C_SD3077_GPIO_Config(void);
