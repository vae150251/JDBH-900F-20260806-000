...
#elif defined SYSCLK_FREQ_176MHz
static void SetSysClockTo176(void);
#elif defined SYSCLK_FREQ_192MHz
static void SetSysClockTo192(void);
#elif defined SYSCLK_FREQ_200MHz
static void SetSysClockTo200(void);
#elif defined SYSCLK_FREQ_224MHz
static void SetSysClockTo224(void);
#elif defined SYSCLK_FREQ_240MHz
...
#ifndef STM32F10X_CL
    pllmull = RCC_GET_PLLMULT(pllmull);
...
#if defined (STM32F10X_403A) || defined (STM32F10X_407)
/**
  * @brief  Delay to wait HSE or PLL ready.
  * @note   This function should be used before reading RCC_CR_HSERDY flag.
  * @param  None
  * @retval None
  */
...
static void SetSysClockTo96(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL12 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo108(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLXTPRE_HSE_Div2 | RCC_CFGR_PLLMULL27 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo120(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL15 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo144(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL18 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo168(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL21 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo176(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL22 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo192(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL24 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo200(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL25 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo224(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL28 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo240(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL30 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo72MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL18);
...
static void SetSysClockTo96MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL24 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo108MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL27 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo120MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL30 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo144MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL36 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo168MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL42 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo176MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL44 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo192MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL48 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo200MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL50 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo224MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL56 | RCC_CFGR_PLLRANGE_GT72MHZ);
...
static void SetSysClockTo200MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL60 | RCC_CFGR_PLLRANGE_GT72MHZ);
