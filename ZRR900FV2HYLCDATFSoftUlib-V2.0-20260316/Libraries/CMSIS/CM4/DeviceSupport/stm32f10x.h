...
/* Uncomment the line below according to the target STM32 device used in your
...
#if !defined (ATF403ACCU7) && !defined (ATF403ACEU7) && !defined (ATF403ACGU7) && \
    !defined (ATF403ACCT7) && !defined (ATF403ACET7) && !defined (ATF403ACGT7) && \
    !defined (ATF403ARCT7) && !defined (ATF403ARET7) && !defined (ATF403ARGT7) && \
    !defined (ATF403AVCT7) && !defined (ATF403AVET7) && !defined (ATF403AVGT7) && \
    !defined (ATF407RCT7)  && !defined (ATF407RET7)  && !defined (ATF407RGT7)  && \
    !defined (ATF407VCT7)  && !defined (ATF407VET7)  && !defined (ATF407VGT7)

 #error "Please select first the correct device used in your application (in stm32f10x.h file)"
#endif
 ...
 #define STM32F10X_403A
#endif

#if defined (ATF407RCT7)  || defined (ATF407RET7)  || defined (ATF407RGT7)  || \
    defined (ATF407VCT7)  || defined (ATF407VET7)  || defined (ATF407VGT7)

 #define STM32F10X_407
#endif
...
/******  STM32 specific Interrupt Numbers *********************************************************/
  ...
  SPI2_I2S2EXT_IRQn           = 36,     /*!< SPI2 & I2SEXT2 Interrupt                             */
  ...
  SPI3_I2S3EXT_IRQn           = 51,     /*!< SPI3 & I2SEXT3 Interrupt                             */
  ...
  CAN2_TX_IRQn                = 68,     /*!< CAN2 TX Interrupts                                   */
  CAN2_RX0_IRQn               = 69,     /*!< CAN2 RX0 Interrupts                                  */
...
#endif /* STM32F10X_403A */

#if defined (STM32F10X_407)
  ADC1_2_IRQn                 = 18,     /*!< ADC1 & ADC2 global Interrupt                         */
  USB_HP_CAN1_TX_IRQn         = 19,     /*!< USB Device High Priority or CAN1 TX Interrupts       */
  USB_LP_CAN1_RX0_IRQn        = 20,     /*!< USB Device Low Priority or CAN1 RX0 Interrupts       */
  CAN1_RX1_IRQn               = 21,     /*!< CAN1 RX1 Interrupt                                   */
  ...
  UART7_IRQn                  = 77,     /*!< UART7 global Interrupt                               */
  UART8_IRQn                  = 78,     /*!< UART8 global Interrupt                               */
  ETH_IRQn                    = 79,     /*!< ETH global Interrupt                                 */
  ETH_WKUP_IRQn               = 80,     /*!< ETH WakeUp global Interrupt                          */
#endif /* STM32F10X_407 */
...
#define OTG_BASE              ((uint32_t)0x50000000) /*!< USBOTG base address in the alias region */
...
#define  RCC_CR_HSITRIM                      ((uint32_t)0x000000FC)        /*!< Internal High Speed clock trimming */
...
#define  RCC_CFGR_ADCPRE                     ((uint32_t)0x1000C000)        /*!< ADCPRE[2:0] bits (ADC prescaler) */
#define  RCC_CFGR_ADCPRE_0                   ((uint32_t)0x00004000)        /*!< Bit 0 */
#define  RCC_CFGR_ADCPRE_1                   ((uint32_t)0x00008000)        /*!< Bit 1 */
#define  RCC_CFGR_ADCPRE_2                   ((uint32_t)0x10000000)        /*!< Bit 2 */
...
#define  RCC_CFGR_PLLMULL                    ((uint32_t)0x603C0000)        /*!< PLLMUL[5:0] bits (PLL multiplication factor) */
#define  RCC_CFGR_PLLMULL_0                  ((uint32_t)0x00040000)        /*!< Bit 0 */
#define  RCC_CFGR_PLLMULL_1                  ((uint32_t)0x00080000)        /*!< Bit 1 */
#define  RCC_CFGR_PLLMULL_2                  ((uint32_t)0x00100000)        /*!< Bit 2 */
#define  RCC_CFGR_PLLMULL_3                  ((uint32_t)0x00200000)        /*!< Bit 3 */
#define  RCC_CFGR_PLLMULL_4                  ((uint32_t)0x20000000)        /*!< Bit 4 */
#define  RCC_CFGR_PLLMULL_5                  ((uint32_t)0x40000000)        /*!< Bit 5 */

#define  RCC_CFGR_PLLMULL_LB_MASK            ((uint32_t)0x003C0000)
#define  RCC_CFGR_PLLMULL_HB_MASK            ((uint32_t)0x60000000)
#define  RCC_CFGR_PLLMULL_LB_POS             ((uint32_t)18)
#define  RCC_CFGR_PLLMULL_HB_POS             ((uint32_t)29)
#define  RCC_CFGR_PLLMULL_HB_OFFSET          ((uint32_t)4)


#define  RCC_CFGR_PLLRANGE                  ((uint32_t)0x80000000)        /*!< PLL Frequency range.  */
#define  RCC_CFGR_PLLRANGE_LE72MHZ          ((uint32_t)0x00000000)        /*!< When PLL frequency is less than or equal to 72MHz */
#define  RCC_CFGR_PLLRANGE_GT72MHZ          ((uint32_t)0x80000000)        /*!< When PLL frequency is greater than 72MHz */
...
#define  RCC_CFGR_PLLMULL17                  ((uint32_t)0x20000000)        /*!< PLL input clock*17 */
#define  RCC_CFGR_PLLMULL18                  ((uint32_t)0x20040000)        /*!< PLL input clock*18 */
#define  RCC_CFGR_PLLMULL19                  ((uint32_t)0x20080000)        /*!< PLL input clock*19 */
#define  RCC_CFGR_PLLMULL20                  ((uint32_t)0x200C0000)        /*!< PLL input clock*20 */
#define  RCC_CFGR_PLLMULL21                  ((uint32_t)0x20100000)        /*!< PLL input clock*21 */
#define  RCC_CFGR_PLLMULL22                  ((uint32_t)0x20140000)        /*!< PLL input clock*22 */
#define  RCC_CFGR_PLLMULL23                  ((uint32_t)0x20180000)        /*!< PLL input clock*23 */
#define  RCC_CFGR_PLLMULL24                  ((uint32_t)0x201C0000)        /*!< PLL input clock*24 */
#define  RCC_CFGR_PLLMULL25                  ((uint32_t)0x20200000)        /*!< PLL input clock*25 */
#define  RCC_CFGR_PLLMULL26                  ((uint32_t)0x20240000)        /*!< PLL input clock*26 */
#define  RCC_CFGR_PLLMULL27                  ((uint32_t)0x20280000)        /*!< PLL input clock*27 */
#define  RCC_CFGR_PLLMULL28                  ((uint32_t)0x202C0000)        /*!< PLL input clock*28 */
#define  RCC_CFGR_PLLMULL29                  ((uint32_t)0x20300000)        /*!< PLL input clock*29 */
#define  RCC_CFGR_PLLMULL30                  ((uint32_t)0x20340000)        /*!< PLL input clock*30 */
#define  RCC_CFGR_PLLMULL31                  ((uint32_t)0x20380000)        /*!< PLL input clock*31 */
#define  RCC_CFGR_PLLMULL32                  ((uint32_t)0x203C0000)        /*!< PLL input clock*32 */
#define  RCC_CFGR_PLLMULL33                  ((uint32_t)0x40000000)        /*!< PLL input clock*33 */
#define  RCC_CFGR_PLLMULL34                  ((uint32_t)0x40040000)        /*!< PLL input clock*34 */
#define  RCC_CFGR_PLLMULL35                  ((uint32_t)0x40080000)        /*!< PLL input clock*35 */
#define  RCC_CFGR_PLLMULL36                  ((uint32_t)0x400C0000)        /*!< PLL input clock*36 */
#define  RCC_CFGR_PLLMULL37                  ((uint32_t)0x40100000)        /*!< PLL input clock*37 */
#define  RCC_CFGR_PLLMULL38                  ((uint32_t)0x40140000)        /*!< PLL input clock*38 */
#define  RCC_CFGR_PLLMULL39                  ((uint32_t)0x40180000)        /*!< PLL input clock*39 */
#define  RCC_CFGR_PLLMULL40                  ((uint32_t)0x401C0000)        /*!< PLL input clock*40 */
#define  RCC_CFGR_PLLMULL41                  ((uint32_t)0x40200000)        /*!< PLL input clock*41 */
#define  RCC_CFGR_PLLMULL42                  ((uint32_t)0x40240000)        /*!< PLL input clock*42 */
#define  RCC_CFGR_PLLMULL43                  ((uint32_t)0x40280000)        /*!< PLL input clock*43 */
#define  RCC_CFGR_PLLMULL44                  ((uint32_t)0x402C0000)        /*!< PLL input clock*44 */
#define  RCC_CFGR_PLLMULL45                  ((uint32_t)0x40300000)        /*!< PLL input clock*45 */
#define  RCC_CFGR_PLLMULL46                  ((uint32_t)0x40340000)        /*!< PLL input clock*46 */
#define  RCC_CFGR_PLLMULL47                  ((uint32_t)0x40380000)        /*!< PLL input clock*47 */
#define  RCC_CFGR_PLLMULL48                  ((uint32_t)0x403C0000)        /*!< PLL input clock*48 */
#define  RCC_CFGR_PLLMULL49                  ((uint32_t)0x60000000)        /*!< PLL input clock*49 */
#define  RCC_CFGR_PLLMULL50                  ((uint32_t)0x60040000)        /*!< PLL input clock*50 */
#define  RCC_CFGR_PLLMULL51                  ((uint32_t)0x60080000)        /*!< PLL input clock*51 */
#define  RCC_CFGR_PLLMULL52                  ((uint32_t)0x600C0000)        /*!< PLL input clock*52 */
#define  RCC_CFGR_PLLMULL53                  ((uint32_t)0x60100000)        /*!< PLL input clock*53 */
#define  RCC_CFGR_PLLMULL54                  ((uint32_t)0x60140000)        /*!< PLL input clock*54 */
#define  RCC_CFGR_PLLMULL55                  ((uint32_t)0x60180000)        /*!< PLL input clock*55 */
#define  RCC_CFGR_PLLMULL56                  ((uint32_t)0x601C0000)        /*!< PLL input clock*56 */
#define  RCC_CFGR_PLLMULL57                  ((uint32_t)0x60200000)        /*!< PLL input clock*57 */
#define  RCC_CFGR_PLLMULL58                  ((uint32_t)0x60240000)        /*!< PLL input clock*58 */
#define  RCC_CFGR_PLLMULL59                  ((uint32_t)0x60280000)        /*!< PLL input clock*59 */
#define  RCC_CFGR_PLLMULL60                  ((uint32_t)0x602C0000)        /*!< PLL input clock*60 */
#define  RCC_CFGR_PLLMULL61                  ((uint32_t)0x60300000)        /*!< PLL input clock*61 */
#define  RCC_CFGR_PLLMULL62                  ((uint32_t)0x60340000)        /*!< PLL input clock*62 */
#define  RCC_CFGR_PLLMULL63                  ((uint32_t)0x60380000)        /*!< PLL input clock*63 */
#define  RCC_CFGR_PLLMULL64                  ((uint32_t)0x603C0000)        /*!< PLL input clock*64 */

#define  RCC_CFGR_USBPSC                     ((uint32_t)0x08C00000)        /*!< USB Device prescaler */
#define  RCC_CFGR_USBPRE                     ((uint32_t)0x00400000)        /*!< USB Device prescaler */
#define  RCC_CFGR_USBPRE_1                   ((uint32_t)0x00800000)        /*!< Bit 1 */
#define  RCC_CFGR_USBPRE_2                   ((uint32_t)0x08000000)        /*!< Bit 2 */
#define  RCC_CFGR_USBPRE_DIV1_5              ((uint32_t)0x00000000)        /*!< SYSCLK divided by 1.5 selected as USB clock source */
#define  RCC_CFGR_USBPRE_DIV1                ((uint32_t)0x00400000)        /*!< SYSCLK selected as USB clock source */
#define  RCC_CFGR_USBPRE_DIV2_5              ((uint32_t)0x00800000)        /*!< SYSCLK divided by 2.5 selected as USB clock source */
#define  RCC_CFGR_USBPRE_DIV2                ((uint32_t)0x00C00000)        /*!< SYSCLK divided by 2 selected as USB clock source */
#define  RCC_CFGR_USBPRE_DIV3_5              ((uint32_t)0x08000000)        /*!< SYSCLK divided by 3.5 selected as USB clock source */
#define  RCC_CFGR_USBPRE_DIV3                ((uint32_t)0x08400000)        /*!< SYSCLK divided by 3 selected as USB clock source */
#define  RCC_CFGR_USBPRE_DIV4                ((uint32_t)0x08800000)        /*!< SYSCLK divided by 4 selected as USB clock source */
#define  RCC_CFGR_USBPRE_DIV4_0              ((uint32_t)0x08C00000)        /*!< SYSCLK divided by 4 selected as USB clock source */
...
#define  RCC_APB2RSTR_ACCRST                 ((uint32_t)0x00400000)        /*!< ACC reset */
#define  RCC_APB2RSTR_I2C3RST                ((uint32_t)0x00800000)        /*!< I2C3 reset */
#define  RCC_APB2RSTR_USART6RST              ((uint32_t)0x01000000)        /*!< USART6 reset */
#define  RCC_APB2RSTR_UART7RST               ((uint32_t)0x02000000)        /*!< UART7 reset */
#define  RCC_APB2RSTR_UART8RST               ((uint32_t)0x04000000)        /*!< UART8 reset */
...
#define  RCC_APB1RSTR_SPI4RST                ((uint32_t)0x00010000)        /*!< SPI 4 reset */
...
#define  RCC_APB1RSTR_CAN2RST                ((uint32_t)0x04000000)        /*!< I2C 3 reset */
...
#define  RCC_AHBENR_SDIO2EN                  ((uint16_t)0x0800)            /*!< SDIO2 clock enable */
...
#define  RCC_AHBENR_ETHMACPTPEN              ((uint32_t)0x10000000)         /*!< ETHERNET MAC PTP clock enable */
...
#define  RCC_APB2ENR_ACCEN                   ((uint32_t)0x00400000)         /*!< ACC clock enable */
#define  RCC_APB2ENR_I2C3EN                  ((uint32_t)0x00800000)         /*!< I2C3 clock enable */
#define  RCC_APB2ENR_USART6EN                ((uint32_t)0x01000000)         /*!< USART6 clock enable */
#define  RCC_APB2ENR_UART7EN                 ((uint32_t)0x02000000)         /*!< UART7 clock enable */
#define  RCC_APB2ENR_UART8EN                 ((uint32_t)0x04000000)         /*!< UART8 clock enable */
...
#define  RCC_APB1ENR_SPI4EN                  ((uint32_t)0x00010000)         /*!< SPI 4 clock enable */
...
#define  RCC_MISC_MCOPRE_MASK                ((uint32_t)0xF0000000)        /*!< MCO Div Configure Mask */
...
#define  RCC_MISC_MCOPRE_512                 ((uint32_t)0xF0000000)
...
#define  RCC_MISC2_EMAC_PPS_SEL_EN           ((uint32_t)0x00008000)        /*!< EMAC PPS select bit */
...
#define AFIO_MAPR2_SPI4_REMAP                ((uint32_t)0x00020000)        /*!< SPI4 remapping */
#define AFIO_MAPR2_I2C3_REMAP                ((uint32_t)0x00040000)        /*!< I2C3 remapping */
#define AFIO_MAPR2_SDIO2_REMAP               ((uint32_t)0x00180000)        /*!< SDIO2 remap[1:0] */
#define AFIO_MAPR2_SDIO2_REMAP_0             ((uint32_t)0x00080000)        /*!< SDIO2 bit0 */
#define AFIO_MAPR2_SDIO2_REMAP_1             ((uint32_t)0x00100000)        /*!< SDIO2 bit1 */
#define AFIO_MAPR2_EXT_SPIF_EN               ((uint32_t)0x00200000)        /*!< EXT SPIF enable */

/******************  Bit definition for AFIO_MAP3 register  ******************/
#define AFIO_MAPR3_TIM9_GRMP                  ((uint32_t)0x00000001)        /*!< TIM9 Alternate Function mapping  */

/******************  Bit definition for AFIO_MAP4 register  ******************/
#define AFIO_MAPR4_TIM1_GRMP                  ((uint32_t)0x00000001)        /*!< TIM1 Alternate Function mapping */
#define AFIO_MAPR4_TIM2_GRMP_01               ((uint32_t)0x00000010)        /*!< TIM2 Alternate Function mapping 0001*/
#define AFIO_MAPR4_TIM2_GRMP_10               ((uint32_t)0x00000020)        /*!< TIM2 Alternate Function mapping 0010*/
#define AFIO_MAPR4_TIM2_GRMP_11               ((uint32_t)0x00000030)        /*!< TIM2 Alternate Function mapping 0011*/
#define AFIO_MAPR4_TIM3_GRMP_10               ((uint32_t)0x00000200)        /*!< TIM3 Alternate Function mapping 0010*/
#define AFIO_MAPR4_TIM3_GRMP_11               ((uint32_t)0x00000300)        /*!< TIM3 Alternate Function mapping 0011*/
#define AFIO_MAPR4_TIM5_GRMP                  ((uint32_t)0x00010000)        /*!< TIM5 Alternate Function mapping : CH1/CH2*/
#define AFIO_MAPR4_TIM5CH4_INTLRE             ((uint32_t)0x00080000)        /*!< TIM5 Channel4 Internal Remap */

/******************  Bit definition for AFIO_MAP5 register  ******************/
#define AFIO_MAPR5_I2C1_GRMP_01               ((uint32_t)0x00000010)        /*!< I2C1 Alternate Function mapping 0001*/
#define AFIO_MAPR5_I2C1_GRMP_11               ((uint32_t)0x00000030)        /*!< I2C1 Alternate Function mapping 0011*/
#define AFIO_MAPR5_I2C2_GRMP_01               ((uint32_t)0x00000100)        /*!< I2C2 Alternate Function mapping 0001*/
#define AFIO_MAPR5_I2C2_GRMP_10               ((uint32_t)0x00000200)        /*!< I2C2 Alternate Function mapping 0010*/
#define AFIO_MAPR5_I2C2_GRMP_11               ((uint32_t)0x00000300)        /*!< I2C2 Alternate Function mapping 0011*/
#define AFIO_MAPR5_SPI1_GRMP                  ((uint32_t)0x00010000)        /*!< SPI1 Alternate Function mapping */
#define AFIO_MAPR5_SPI2_GRMP                  ((uint32_t)0x00100000)        /*!< SPI2 Alternate Function mapping */

/******************  Bit definition for AFIO_MAP6 register  ******************/
#define AFIO_MAPR6_CAN1_GRMP                  ((uint32_t)0x00000002)        /*!< CAN1 Alternate Function mapping */
#define AFIO_MAPR6_CAN2_GRMP                  ((uint32_t)0x00000010)        /*!< CAN2 Alternate Function mapping */
#define AFIO_MAPR6_SDIO_GRMP_100              ((uint32_t)0x00000400)        /*!< SDIO Alternate Function mapping 100 */
#define AFIO_MAPR6_SDIO_GRMP_101              ((uint32_t)0x00000500)        /*!< SDIO Alternate Function mapping 101 */
#define AFIO_MAPR6_SDIO_GRMP_110              ((uint32_t)0x00000600)        /*!< SDIO Alternate Function mapping 110 */
#define AFIO_MAPR6_SDIO_GRMP_111              ((uint32_t)0x00000700)        /*!< SDIO Alternate Function mapping 111 */
#define AFIO_MAPR6_USART1_GRMP                ((uint32_t)0x00010000)        /*!< USART1 Alternate Function mapping */
#define AFIO_MAPR6_USART3_GRMP                ((uint32_t)0x01000000)        /*!< USART3 Partial Alternate Function mapping */
#define AFIO_MAPR6_UART4_GRMP                 ((uint32_t)0x10000000)        /*!< UART4 Alternate Function mapping */

/******************  Bit definition for AFIO_MAP7 register  ******************/
#define AFIO_MAPR7_SPIF_GRMP_1000             ((uint32_t)0x00000008)        /*!< EXT_FLASH Alternate Function mapping */ 
#define AFIO_MAPR7_SPIF_GRMP_1001             ((uint32_t)0x00000009)        /*!< EXT_FLASH Alternate Function enable */ 
#define AFIO_MAPR7_ADC1_GRMP_01               ((uint32_t)0x00000010)        /*!< ADC1 External Trigger Injected Conversion remapping */
#define AFIO_MAPR7_ADC1_GRMP_10               ((uint32_t)0x00000020)        /*!< ADC1 External Trigger Regular Conversion remapping */
#define AFIO_MAPR7_ADC1_GRMP_11               ((uint32_t)0x00000030)        /*!< ADC1 External Trigger Regular & Injected Conversion remapping */
#define AFIO_MAPR7_ADC2_GRMP_01               ((uint32_t)0x00000100)        /*!< ADC2 External Trigger Injected Conversion remapping */
#define AFIO_MAPR7_ADC2_GRMP_10               ((uint32_t)0x00000200)        /*!< ADC2 External Trigger Regular Conversion remapping */
#define AFIO_MAPR7_ADC2_GRMP_11               ((uint32_t)0x00000300)        /*!< ADC2 External Trigger Regular & Injected Conversion remapping */
#define AFIO_MAPR7_SWJTAG_GRMP_001            ((uint32_t)0x00010000)        /*!< Full SWJ Enabled (JTAG-DP + SW-DP) but without JTRST */
#define AFIO_MAPR7_SWJTAG_GRMP_010            ((uint32_t)0x00020000)        /*!< JTAG-DP Disabled and SW-DP Enabled */
#define AFIO_MAPR7_SWJTAG_GRMP_100            ((uint32_t)0x00040000)        /*!< Full SWJ Disabled (JTAG-DP + SW-DP) */
#define AFIO_MAPR7_PD01_GRMP                  ((uint32_t)0x00100000)        /*!< PD01 Alternate Function mapping */ 
...
#define  ADC_CR2_JEXTSEL_3                   ((uint32_t)0x01000000)        /*!< Bit 3 */
...
#define  ADC_CR2_EXTSEL_3                    ((uint32_t)0x02000000)        /*!< Bit 3 */
...
#define  TIM_CR1_PMEN                        ((uint16_t)0x0400)            /*!< 32 bit timer enable */
...
#define  SPI_CR2_MCLKP_EXT                	 ((uint16_t)0x0100)            /*!< BR[3] bits (Baud Rate Control) */
#define  SPI_CR2_MCLKP_3                  	 ((uint16_t)0x0100)            /*!< Bit 3 */
...
#define  I2C_CR2_FREQ_6                      ((uint16_t)0x0040)            /*!< Bit 6 */
#define  I2C_CR2_FREQ_7                      ((uint16_t)0x0080)            /*!< Bit 7 */
...
#define  DBGMCU_CR_DBG_TIM9_STOP             ((uint32_t)0x10000000)        /*!< TIM9 counter stopped when core is halted */
#define  DBGMCU_CR_DBG_TIM10_STOP            ((uint32_t)0x20000000)        /*!< TIM10 counter stopped when core is halted */
#define  DBGMCU_CR_DBG_TIM11_STOP            ((uint32_t)0x40000000)        /*!< TIM11 counter stopped when core is halted */
#if defined(STM32F10X_403A) || defined (STM32F10X_407)
#define  DBGMCU_CR_DBG_CAN2_STOP             ((uint32_t)0x00200000)        /*!< TIM15 counter stopped when core is halted */
#else
...
#define  DBGMCU_CR_DBG_TIM15_STOP            ((uint32_t)0x00400000)        /*!< TIM15 counter stopped when core is halted */
#define  DBGMCU_CR_DBG_TIM12_STOP            ((uint32_t)0x02000000)        /*!< TIM12 counter stopped when core is halted */
#define  DBGMCU_CR_DBG_TIM13_STOP            ((uint32_t)0x04000000)        /*!< TIM13 counter stopped when core is halted */
#define  DBGMCU_CR_DBG_TIM14_STOP            ((uint32_t)0x08000000)        /*!< TIM14 counter stopped when core is halted */
#define  DBGMCU_CR_DBG_I2C3_SMBUS_TIMEOUT    ((uint32_t)0x80000000)        /*!< SMBUS timeout mode stopped when Core is halted */
#endif
...
#define  FLASH_ACR_LATENCY_3                 ((uint8_t)0x03)               /*!< Bit 0:1 */
